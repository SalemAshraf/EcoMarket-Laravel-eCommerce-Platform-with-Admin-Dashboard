                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            ...
                            <div class="item" id="imgpreview">
                                <img src="{{asset('uploads')}}/{{$product->image}}" class="effect8" alt="">
                            </div>
                            @endif
                            ...
                            @if($product->images)
                                @foreach(explode(",",$product->images) as $img)
                                    <div class="item gitems">
                                        <img src="{{asset('uploads')}}/{{trim($img)}}" class="effect8" alt="">
                                    </div>
                                @endforeach
                            @endif
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // خليك تمسك كل الصور الموجودة في الصفحة
        document.querySelectorAll("img").forEach(function(img) {
            img.onerror = function() {
                console.error("❌ خطأ في تحميل الصورة:", img.src);
            };
        });
    });
</script>
