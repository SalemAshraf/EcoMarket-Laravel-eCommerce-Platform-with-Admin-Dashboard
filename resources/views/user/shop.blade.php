                                        ...
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                <input type="checkbox" name="categories" value="{{$category->id}}"
                                                    class="chk-category" @if(in_array($category->id, explode(',', $f_categories))) checked="checked" @endif />
                                                {{$category->name}}
                                            </span>
                                            <span class="text-right float-right">{{$category->products()->count()}}
                                            </span>
                                        </li>
                                    @endforeach
                                </ul>
                                    ...
                                    @foreach ($brands as $brand)
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                ...
                                                {{$brand->name}}</span>
                                            <span class="text-right float-right">{{$brand->products()->count()}}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="price-range__info d-flex align-items-center mt-2">
                                <div class="me-auto">
                                    ...
                                    <span class="price-range__min">EGP 1</span>
                                </div>
                                <div>
                                    <span class="text-secondary">Max Price: </span>
                                    <span class="price-range__max">EGP 10,000</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        {{-- <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            ...
                            <option value="price-desc" {{$sorting=='price-desc' ? 'selected' : '' }}>Sort by price: high to
                                low
                            </option>
                        </select> --}}
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{route('shop.product.details', ["product_slug" => $product->slug])}}">
                                                    <img loading="lazy" src="{{asset('uploads')}}/{{$product->image}}"
                                            ...
                                            <div class="swiper-slide">
                                                @foreach (explode(",", $product->images) as $gimg)
                                                    <a href="{{route('shop.product.details', ["product_slug" => $product->slug])}}">
                                                        <img loading="lazy" src="{{asset('uploads')}}/{{trim($gimg)}}" width="330"
